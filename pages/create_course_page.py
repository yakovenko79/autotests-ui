...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_exercise_add_button = page.get_by_test_id('create-course-exercises-box-toolbar-create-exercise'
                                                              '-button')
        ...
        self.exercise_empty_view_description = page.get_by_test_id('create-course-exercises-empty-view-description'
                                                                   '-text')
    ...
    def check_visible_create_exercise_button(self):
        expect(self.create_exercise_add_button).to_be_visible()
        expect(self.create_exercise_add_button).to_be_enabled()

    def click_create_exercise_button(self):
        self.create_exercise_add_button.click()
    ...
    def check_visible_exercises_empty_view(self):
        ...
        expect(self.exercise_empty_view_description).to_have_text('Click on "Create exercise" button to create new '
                                                                  'exercise')
    ...
    def click_delete_exercise_button(self, index: int):
        delete_exercise_button = self.page.get_by_test_id(f'create-course-exercise-{index}-box-toolbar-delete'
                                                          f'-exercise-button')
